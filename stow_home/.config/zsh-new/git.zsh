...
# file itself never defines -- it lives in OMZ's core lib/git.zsh alongside
# its own helper, `__git_prompt_git`. Both are copied verbatim here so this
# file has no dependency on OMZ being installed.
